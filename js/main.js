...
var swiper = new Swiper(".weare__swiper", {
	mousewheel: {
		releaseOnEdges: true,
		sensitivity: 100
	},
...
var swiper = new Swiper(".be-bigger__swiper", {
	slidesPerView: 1,
	mousewheel: {
		releaseOnEdges: true
	},
...
var swiper = new Swiper(".attract__swiper", {
	mousewheel: {
		releaseOnEdges: true,
		sensitivity: 100
	},
...
$('.color-select__item button').on('click', function (e) {
	e.preventDefault()
	active_color_img = false
	$(this).parents('.color-select__list').find('button').removeClass('color-select__btn--active')
	$(this).addClass('color-select__btn--active')
	$(this).parents('.shop__item').find('img').attr('src', $(this).attr('data-url'))
})

$('.color-select__item button').hover(
	function () {
...
$('.cart__more-btn').click(function () {
	$('.cart__more-text--hide').slideToggle();
